...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec 10 16:18:49 2024
...
P0_chi=[(np.amax(ps_data)+np.amin(ps_data))/2, np.amax(ps_data)-np.amin(ps_data), 8, -4]
B0_chi=([0,10,0,-2*np.pi],[3000,3000,10, 6*np.pi])
