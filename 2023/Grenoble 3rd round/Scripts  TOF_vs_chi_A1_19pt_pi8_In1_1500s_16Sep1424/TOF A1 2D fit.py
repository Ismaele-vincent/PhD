...
inf_file_name="TOF_vs_chi_A1_19pt_pi8_In1_1500s_16Sep1424"
...
p,cov=fit(fit_cos, ps_pos[2:], ps_data[2:], p0=P0,  bounds=B0)
chi_0 = p[-1]
w_ps=p[-2]
...
C=0.6526851007101038
C_err=0.020031617082422556
eta = 1-C
...
ax = fig.add_subplot(111)
# ax.errorbar(np.arange(len(matrix.ravel())),matrix.ravel(), yerr=matrix_err.ravel(), fmt="k.", capsize=3, lw=0.5)
