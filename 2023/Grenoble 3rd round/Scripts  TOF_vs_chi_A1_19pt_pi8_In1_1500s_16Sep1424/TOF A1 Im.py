...
for inf_file_name in inf_file_names:
    ...
    for i in range(len(ps_pos)):
        ...
        c_0_data=abs(yf_data[abs(xf)<1/S_F/2]).astype(complex)-20766.24537670226
        var=np.sum(func_data)**0.5/2
        c_1_data_err=var
        c_0_data_err=(var**2+ 1228.7764280562756**2)**0.5
    ...
    plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 3rd round/Report/Images/Im A1 corrected.pdf", format="pdf", bbox_inches="tight")
