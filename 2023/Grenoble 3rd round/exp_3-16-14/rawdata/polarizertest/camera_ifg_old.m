...
fitareaGauss[images_,imgpar_,x_,y_,dx_,dy_,minIntensity_,ignorebelow_]:=Module[{ imgdata,fitdata,fitres,totalIntensity, c,offs,ampl,pos,sig,fwhm},
(*imgdata=cut[images,tileDX,tileDY,nx,ny];*)
imgdata=cutarea[images,x,y,dx,dy];
fitdata=getfitdata[imgdata];
totalIntensity=If[ArrayDepth[fitdata]==1,Total[fitdata],Total[Transpose[fitdata][[2]]]];
fitdata=If[Length[fitdata]==Length[imgpar],Transpose[{imgpar,fitdata}],fitdata];
...
fittileGauss[images_,imgpar_,tileDX_,tileDY_,nx_,ny_,minIntensity_,ignorebelow_]:=Module[{},
fitareaGauss[images,imgpar,(nx-1)*tileDX,(ny-1)*tileDY,tileDX,tileDY,minIntensity,ignorebelow]
]

fitgridGauss[images_,imgpar_,tileDX_,tileDY_,minIntensity_,ignorebelow_]:=Module[{},
Table[fittileGauss[images,imgpar,tileDX,tileDY,nx,ny,minIntensity,ignorebelow],{ny,1,Floor[Length[images[[1]]]/tileDY]},{nx,1,Floor[Length[images[[1,1]]]/tileDX]}]
]
...
plotresGauss[res_]:=plotresGauss[res,300]
...
Table[fittileTwoGauss[images,tileDX,tileDY,nx,ny,minIntensity,period],{ny,1,Floor[Length[images[[1]]]/tileDY]},{nx,1,Floor[Length[images[[1,1]]]/tileDX]}]
]
...
ArrayPlot[peaksepTable[res]*stepwidth,DataRange->{drx,dry},PlotRange->{prx,pry,{0,20*stepwidth}},FrameTicks->{Automatic,Automatic},ImageSize->180,AspectRatio->ar,PlotLegends->Automatic,PlotLabel->"Peak Separation",ColorFunction->"CoffeeTones"]
 }]
]
