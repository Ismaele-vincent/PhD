...
data_fold_path="/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Paper/Results txt fit/No In"
...
for ax in axs[:-1]:
    ...
    ax.legend(loc=3, ncol=1, framealpha=1, fontsize=10)#, bbox_to_anchor=(0,0.45))
    k+=1
