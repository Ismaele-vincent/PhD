...
axsl[0].plot(chi_plt, w1(chi_plt).imag, "-",color=colors[3], alpha=1, label="Theory")
...
axsl[1].plot(chi_plt, w1(chi_plt).real, "-", color=colors[3], alpha=1)
...
axsc[0].plot(chi_plt, w2(chi_plt).imag, "-",color=colors[3], alpha=1, label="$\Im(w_{2,+})$ theory")
...
axsc[1].plot(chi_plt, w2(chi_plt).real, "-", color=colors[3], alpha=1, label="Theory")
...
axsr[0].plot(chi_plt, w1(chi_plt).imag+w2(chi_plt).imag, "-",color=colors[3], alpha=1, label="$\Im(w_{2,+})$ theory")
...
axsr[1].plot(chi_plt, w2(chi_plt).real+w1(chi_plt).real, "-", color=colors[3], alpha=1)#, label="Theory")
...
# axsl[1].plot([],[], "-",color=colors[3], alpha=1, label="Theory")
