...
inf_file_name_pi8="TOF_vs_chi_A_22pt_pi8_1200s_06Nov1855" 
inf_file_name_pi16="TOF_vs_chi_A_22pt_pi16_1200s_07Nov1808"
# inf_file_name_pi8="TOF_vs_chi_A_19pt_pi8_1200s_04Nov1722"
# inf_file_name_pi16="TOF_vs_chi_A_19pt_pi16_1200s_05Nov1903"
alpha_1_pi8=0.3847 #/2.354
alpha_1_pi8_err=0.0017 

alpha_1_pi16=0.1923 #/2.354
alpha_1_pi16_err=0.0009 
...
def fit_Im(t, B, Im_1, xi_1):
    return B*(1-2*Im_1*np.sin(2*np.pi*1e-3*f_1*t+xi_1))
    # return A_aus*((1-C_id)/2+C_id*B*(1-2*Im_1*alpha_1_pi8*np.sin(2*np.pi*1e-3*f_1*t+xi_1)-2*Im_2*alpha_2*np.sin(2*np.pi*1e-3*f_2*t+xi_2)))

sorted_fold_path_pi8="/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/exp_CRG-3061/Sorted data/TOF A/"+inf_file_name_pi8
...
sorted_fold_path_pi16="/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/exp_CRG-3061/Sorted data/TOF A/"+inf_file_name_pi16
...
j0_1=jv(0,alpha_1_pi8)
j0_1_err=abs(djv0(alpha_1_pi8)*alpha_1_pi8_err)
C_D_pi8=(2*a_1*a_2*j0_1)
C_id_pi8 = p_int_pi8[1]/C_D_pi8
C_id_pi8_err = ((C_D_pi8*err_int_pi8[1])**2+(C_D_pi8*a_1_err/a_1)**2+(C_D_pi8*j0_1_err/j0_1)**2)**0.5
...
j0_1=jv(0,alpha_1_pi16)
j0_1_err=abs(djv0(alpha_1_pi16)*alpha_1_pi16_err)
C_D_pi16=(2*a_1*a_2*j0_1)
C_id_pi16 = p_int_pi16[1]/C_D_pi16
C_id_pi16_err = ((C_D_pi16*err_int_pi16[1])**2+(C_D_pi16*a_1_err/a_1)**2+(C_D_pi16*j0_1_err/j0_1)**2)**0.5
...
psi_in=(int_data_pi8_corr-0.5)/jv(0,alpha_1_pi8)+0.5
# fig = plt.figure(figsize=(8,6))
# ax = fig.add_subplot(111)
# ax.plot(psi_in)
Re_1=(int_data_pi8_corr-psi_in)/psi_in/alpha_1_pi8**2
Re_err_1=Re_1*0
...
for ax in axs:
    ax.errorbar(chi_pi8[:-7], Re_1[:-7], Re_err_1[:-7], fmt=".", color=colors[2], capsize=3)
    ax.plot(chi_pi8_plt[chi_pi8_plt<xlim2], w1(chi_pi8_plt).real[chi_pi8_plt<xlim2], "--", color=colors[2], alpha=0.5)
    ax.grid(True, ls="dotted")
    # ax.set_xlim([xlim1,xlim2])
# axs[0].set_ylim([-2.5,5])
axs[0].set_ylim([6,np.amax(Re_1)+np.amax(Re_err_1)*1.5])
