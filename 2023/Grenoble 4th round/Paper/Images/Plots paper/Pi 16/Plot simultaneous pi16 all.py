...
fig_all = plt.figure(figsize=(5, 4), dpi=200)
ax_all = fig_all.add_subplot(111)
colors=["k","#f10d0c","#00a933","#5983b0"]
ax_all.errorbar(chi, Im_data_1, Im_data_err_1, fmt="k.", capsize=3, label="$\Im(w_{1,+})$ data")
ax_all.plot(chi_plt, w1(chi_plt).imag, "k--", alpha=0.5, label="$\Im(w_{1,+})$ theory")
ax_all.errorbar(chi, Im_data_2, Im_data_err_2, fmt=".", color=colors[2], capsize=3, label="$\Im(w_{2,+})$ data")
ax_all.plot(chi_plt, w2(chi_plt).imag, "--",color=colors[2], alpha=0.5, label="$\Im(w_{2,+})$ theory")
ax_all.set_ylim([-2.1,2.1])
ax_all.set_xlabel("$\\chi$ [rad]")
...
colors=["k","#f10d0c","#00a933","#5983b0"]
ax_all.errorbar(chi, Im_data_1, Im_data_err_1, fmt=".", color=colors[1], capsize=3, label="$\Im(w_{1,+})$ data")
ax_all.plot(chi_plt, w1(chi_plt).imag, "--", color=colors[1],alpha=0.5, label="$\Im(w_{1,+})$ theory")
ax_all.errorbar(chi, Im_data_2, Im_data_err_2, fmt=".", color=colors[3], capsize=3, label="$\Im(w_{2,+})$ data")
ax_all.plot(chi_plt, w2(chi_plt).imag, "--",color=colors[3], alpha=0.5, label="$\Im(w_{2,+})$ theory")


# ax_all.legend()
# plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Paper/Images/Simoultaneous pi16 no In.pdf", format="pdf",bbox_inches="tight")
