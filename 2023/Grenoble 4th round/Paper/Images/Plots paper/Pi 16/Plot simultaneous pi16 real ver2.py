...
# axs[0].plot([xlim1,xlim2],[ylim1,ylim1], "k", lw=1, ls=(0,(5,3)))
# axs[0].plot([xlim1,xlim2],[ylim2,ylim2], "k", lw=1, ls=(0,(5,3)))

kwargs = dict(transform=axs[1].transAxes, color='k', ls="dashed", lw=1, clip_on=False)
axs[1].plot((-0.095, 0), (0.4, 0), **kwargs)
axs[1].plot((-0.095, 0), (0.48, 1), **kwargs)
kwargs = dict(transform=axs[0].transAxes, color='k', ls="dashed", lw=1, clip_on=False)
axs[1].plot((0, 1), (0.405, 0.405), **kwargs)
axs[1].plot((0, 1), (0.48, 0.48), **kwargs)

plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Paper/Images/Simoultaneous pi16 real ver2.pdf", format="pdf",bbox_inches="tight")
