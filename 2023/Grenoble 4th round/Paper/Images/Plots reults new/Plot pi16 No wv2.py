...
gs = fig.add_gridspec(3, 1,  height_ratios=(7,1, 6), hspace=0.0)
...
axs[2].errorbar(chi, Im_data_2, Im_data_err_2, fmt=".", color=colors[1], capsize=3, label="$\Im(w_{2,+})$ data")
axs[2].plot(chi_plt, w2(chi_plt).imag, "--",color=colors[1], alpha=0.5, label="$\Im(w_{2,+})$ theory")
axs[2].set_ylim([ylim_im_1,ylim_im_2])
axs[2].set_yticks(ticks=y_im_labels)
axs[2].grid(True, ls="dotted")
axs[2].set_xlim([chi[0]-0.2,chi[-1]+0.2])
axs[2].yaxis.set_label_position("right")
axs[2].set_ylabel("$w^\Im_{+,2}$", fontsize=12, rotation=270, va="bottom", ha="center")

axs[0].set_ylim([ylim_re_2,np.amax(Re_2)*1.5])
axs[1].set_ylim([ylim_re_1,ylim_re_2])
...
# ax.legend()
# plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Paper/Images/New plot results/Wv2"+inf_file_name[-10:]+"Imaginary.pdf", format="pdf",bbox_inches="tight")
