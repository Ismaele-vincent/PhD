...
for i in range(len(ps_pos)):
    ...
    # print(P0)
    B0=([0,w1(chi[i]).imag-1000,w1(chi[i]).real-10, -2*np.pi],[np.inf, w1(chi[i]).imag+1000, w1(chi[i]).real+10, 2*np.pi])
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/Results_A_pi2_no_In_strong_err.pdf", format="pdf",bbox_inches="tight")
