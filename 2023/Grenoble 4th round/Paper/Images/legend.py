...
fig = plt.figure(figsize=(5,0.5), dpi=200)
...
ax.errorbar([], [], [], fmt=".", color=colors[2], capsize=3, label="$w^\Re_{+,1}$ Data")
ax.errorbar([],[], fmt="--", color=colors[2], alpha=0.5,label="$w^\Re_{+,1}$  Theory")    
ax.errorbar([], [], [], fmt=".", color=colors[1], capsize=3, label="$w^\Im_{+,2}$ Data")
ax.errorbar([],[], fmt="--", color=colors[1], alpha=0.5,label="$w^\Im_{+,2}$  Theory")    
ax.errorbar([], [], [], fmt=".", color=colors[3], capsize=3, label="$w^\Re_{+,2}$ Data")
ax.errorbar([],[], fmt="--", color=colors[3], alpha=0.5,label="$w^\Re_{+,2}$  Theory")    
fig.legend(ncol=4, framealpha=1,frameon=0, loc=10)
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Paper/Images/legend Wv.pdf", format="pdf",bbox_inches="tight")
