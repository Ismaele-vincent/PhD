...
fig.legend(ncol=2, framealpha=1,frameon=0, loc=10)
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Paper/Images/legend Im.pdf", format="pdf",bbox_inches="tight")
