...
B0=([10,0,0.01,-10],[np.amax(ps_data)+10000,2,5, 10])
p,cov=fit(fit_cos, ps_pos, ps_data, p0=P0,  bounds=B0)
err=np.diag(cov)**0.5
Co = p[1]/0.95#0.7456183532707045
Co_err= err[1]#0.00646151528318766
A=p[0]*(1-Co)/2
...
fig.suptitle("$\mathbf{a_2/a_1=1.375}$",bbox=dict(facecolor='none', edgecolor='k'))
# fig.suptitle(inf_file_name+"\t $(a_2/a_1\\approx 1.375)$", fontweight="bold")#, $\mathbf{\\alpha=\pi/16}$")
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/Results_pi16_In_0p8_C_corr.pdf", format="pdf",bbox_inches="tight")
plt.show()
