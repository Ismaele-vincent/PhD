...
def fit_Im(t, B, Im_2, xi_2):
    return A_aus*((1-C_id)/2+C_id*B*(1-2*Im_2*alpha_2*np.sin(2*np.pi*1e-3*f_2*t+xi_2)))
...
# plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Paper/Images/Results_B_pi16_no_In.pdf", format="pdf",bbox_inches="tight")
