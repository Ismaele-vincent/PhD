...
err=np.diag(cov)**0.5
Co = 0.7570578748778914
Co_err=0.006671918238853145
A=p[0]*(1-Co)/2
A_err= (((1-Co)/2*err[0])**2+(p[0]/2*err[1])**2)**0.5
A_aus=p[0]/len(time)
w_ps=p[-2]
chi_0=p[-1]
chi_0_err=err[-1]TOF_vs_chi_B_22pt_pi16_1200s_07Nov1016
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/Results_B_pi16_In_1p8.pdf", format="pdf",bbox_inches="tight")
