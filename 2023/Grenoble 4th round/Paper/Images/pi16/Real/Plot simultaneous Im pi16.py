...
for i in range(len(ps_pos)):
    ...
    chi_aus=chi[i]
    P0=[np.cos(chi[i]/2)**2, w1(chi[i]).imag, w2(chi[i]).imag, -1, 1]
    # print(P0)
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/Results_pi16_no_In_Re.pdf", format="pdf",bbox_inches="tight")

# fig = plt.figure(figsize=(8,6), dpi=200)
# ax = fig.add_subplot(111)
# ax.errorbar(ps_pos, cos2, yerr=cos2_err, fmt="k.", capsize=5, label="$c_0$")
# ax.plot(ps_plt, A_aus*Co*len(time)*np.cos(chi_plt/2)**2)
