...
err=np.diag(cov)**0.5
Co = 0.7439665188351513
Co_err=0.004112086285232811
A=p[0]*(1-Co)/2
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/Results_B_pi8_In_1p8.pdf", format="pdf",bbox_inches="tight")
