...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan 12 15:17:04 2024
...
# inf_file_name="TOF_vs_chi_A+B_In1_22pt_pi8_1200s_4P_16Nov0930" #not good
...
err=np.diag(cov)**0.5
Co = 0.7507177283042706 
Co_err= 0.006633094863835223
A=p[0]*(1-Co)/2
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/Results_pi8_In_1p8.pdf", format="pdf",bbox_inches="tight")
