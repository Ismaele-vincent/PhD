...
inf_file_name="TOF_vs_chi_A+B_22pt_pi8_1200s_4P_11Nov2118" #-4542.815881358124
...
for i in range(len(ps_pos)):
    ...
    c_0_data=abs(yf_data[abs(xf)<1/S_F/2]).astype(complex)#-A#-4542.815881358124#-4674.84261136054#-4143.756564183297#-4220.601952637239#-3798.2582242269036
