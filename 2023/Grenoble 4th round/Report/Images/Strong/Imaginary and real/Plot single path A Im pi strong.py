...
# -*- coding: utf-8 -*-
"""
Created on Tue Jan 23 18:10:15 2024
...
B0=([10,0,0.01,-10],[np.amax(ps_data)+100000,np.amax(ps_data)+10000,5, 10])
...
fig.suptitle("$\mathbf{\\alpha=\pi}$",bbox=dict(facecolor='none', edgecolor='k'))
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/Results_A_pi_no_In_strong.pdf", format="pdf",bbox_inches="tight")
