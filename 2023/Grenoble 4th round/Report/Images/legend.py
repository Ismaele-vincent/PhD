...
ax.plot([], "k--", alpha=0.5,label="$\Im(w_{+,1})$  Theory")    
ax.errorbar([], [], [], fmt="k.", capsize=3, label="$\Im(w_{+,1})$ Data")
ax.plot([], "g--", alpha=0.5,label="$\Im(w_{+,2})$  Theory")    
ax.errorbar([], [], [], fmt="g.", capsize=3, label="$\Im(w_{+,2})$ Data")
fig.legend(ncol=4, framealpha=1,frameon=0, loc=10)
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/legend Im.pdf", format="pdf",bbox_inches="tight")
...
fig.legend(ncol=4, framealpha=1,frameon=0, loc=10)
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/legend Re.pdf", format="pdf",bbox_inches="tight")
