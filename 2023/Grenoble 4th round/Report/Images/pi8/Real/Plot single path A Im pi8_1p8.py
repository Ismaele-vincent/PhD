...
err=np.diag(cov)**0.5
Co = 0.7323053767392436 
Co_err = 0.004788083333389224
A=p[0]*(1-Co)/2
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2023/Grenoble 4th round/Report/Images/Results_A_pi8_In_1p8.pdf", format="pdf",bbox_inches="tight")
