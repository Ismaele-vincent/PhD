...
def fit_cos(x, A, B, C, D):
    return A+B*jv(0,alpha_1)**2*np.cos(C*x-D)
...
for i in range(len(ps_pos)):
    ...
    if i==0:
        ...
        x_2=f_2
        print(x_1)
    c_0_data=abs(yf_data[abs(xf)<1/S_F/2]).astype(complex)-2199.4016360431433#-3963.5934009557927 #-3421.187068197044
