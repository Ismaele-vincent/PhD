...
inf_file_name="TOF_vs_chi_A+B_In1_22pt_pi16_1200s_4P_16Nov0206"
# inf_file_name="TOF_vs_chi_A+B_In1_22pt_pi8_1200s_4P_16Nov0930"
...
P0=[(np.amax(ps_data)+np.amin(ps_data))/2, (np.amax(ps_data)-np.amin(ps_data))/2, 3, -1]
