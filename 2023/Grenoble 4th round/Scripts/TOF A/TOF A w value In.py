...
alpha_1= -np.pi/16 #0.19181329#np.pi/16 #/2.354
alpha_1_err=0.05*alpha_1
def w2(chi):
...
for i in range(len(ps_pos)):
    ...
    c_0_data=abs(yf_data[abs(xf)<1/S_F/2]).astype(complex)-2076.5011147667847#-2036.9095060546083#-2081.2995290488734#-2189.032267011502#-2485.7774593355953#-2382.0766209446774#-3597.8672630959286 #-3932.178382693772
