...
# a_2_err= 0.002
# a_21=a_2/a_1
# # inf_file_name_ifg="ifgPS1_2p_22pt_08Apr0524"
# inf_file_name="TOF_vs_chi_alpha2_22pt_Bessel_0_2kHz_1200s_08Apr0533"
...
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2024/Grenoble 1st round - bis/Report/Images/Results path 2/Integ_int_"+inf_file_name[-9:]+".pdf", format="pdf",bbox_inches="tight")
...
for i in range(len(ps_pos)):
    ...
    chi_aus=chi[i]
    P0=[np.cos(chi[i]/2)**2, w2(chi[i],a_21).imag, abs(w2(chi[i],a_21))-w2(chi[i],a_21).real-1000, xi_0]
    # print(P0)
    B0=([0,w2(chi[i],a_21).imag-1000,abs(w2(chi[i],a_21))-w2(chi[i],a_21).real-1000, -2*np.pi],[np.inf, w2(chi[i],a_21).imag+1000, abs(w2(chi[i],a_21))-w2(chi[i],a_21).real+1000, 2*np.pi])
    try: 
...
axs[1].plot(chi_plt, w2(chi_plt,a_21).imag,"k--", alpha=0.5)
