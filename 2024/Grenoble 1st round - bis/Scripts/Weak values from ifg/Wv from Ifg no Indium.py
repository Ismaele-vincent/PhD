...
for inf_file_name in inf_file_names:
        ...
        print("C_4p=",C_avg)
        print("A_4p=",A_avg)
        data_ifg_matrix_4p-=A_4p*(1-C_avg)
        # fig = plt.figure(figsize=(8,6))
        # ax = fig.add_subplot(111)
        ...
        fig = plt.figure(figsize=(8,6))
        fig.suptitle(inf_file_name[:-4]+" $\Re(w)$")
        ax = fig.add_subplot(111)
        ax.plot(chi_4p,Re, "k.")
        ...
        print("C_1p=",C_avg)
        print("A_1p=",A_avg)
        data_ifg_matrix_1p-=A_1p*(1-C_avg)
        # fig = plt.figure(figsize=(8,6))
        # ax = fig.add_subplot(111)
        ...
        Re=(1+abs(data_ifg_matrix_1p[2]/data_ifg_matrix_1p[0]-4*Im**2)**0.5)/2
        fig = plt.figure(figsize=(8,6))
