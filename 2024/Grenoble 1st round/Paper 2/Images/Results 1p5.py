...
fig.suptitle("$a_2/a_1\\approx 0.59$", fontsize=15)
colors=["k","#f10d0c","#00a933","#5983b0"]
plt.rcParams["mathtext.fontset"]="cm"

xlim=[-1.7*np.pi,1.7*np.pi]
...
xlim=[-1.7*np.pi,1.7*np.pi]
# ylim=axs_l[1].get_ylim()[:]
axs_l[1].fill_between(xlim, -2, 0, color= colors[1], alpha= 0.05)
axs_l[1].set_ylim([-0.12,0.38])
...
axs_r[0].fill_between(axs_r[2].get_xlim(), 1, 5, color= colors[1], alpha= 0.05)
axs_r[1].fill_between(axs_r[2].get_xlim(), -2, 0, color= colors[1], alpha= 0.05)

axs_r[0].set_ylim([0.5,2.5])
axs_r[1].set_ylim([-1.5,0.5])
axs_r[0].set_yticks([1, 1.5, 2])
axs_r[1].set_yticks([-1,-0.5,0])

axs_r[2].set_ylim([-1.125,1.125])
axs_r[3].set_ylim([-1.125,1.125])
axs_r[2].set_yticks([-1,-0.5, 0, 0.5, 1])
axs_r[3].set_yticks([-1,-0.5,0,0.5,1])
...
axs_l[1].plot(axs_l[2].get_xlim(), [0,0], "-", color=colors[1])
axs_r[1].plot(axs_r[2].get_xlim(), [0,0], "-", color=colors[1], label="Contextuality bound")
axs_r[0].plot(axs_r[2].get_xlim(), [1,1], "-", color=colors[1])
