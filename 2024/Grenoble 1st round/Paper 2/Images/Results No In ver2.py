...
I_p=data_ifg_matrix[0]/(data_ifg_matrix[0]+data_ifg_matrix[2])
ReKD_2=(1-Re_1_1)*I_p
I_p_err=((data_ifg_matrix[2]*data_ifg_matrix_err[0])**2+data_ifg_matrix_err[2]**2)**0.5/(data_ifg_matrix[0]+data_ifg_matrix[2])**2

ReKD_2_err=((Re_1_1*I_p_err)**2 + (I_p*Re_1_1_err)**2)**0.5
