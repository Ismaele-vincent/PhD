...
def wp2(chi, a_21):
    return 1-wp1(chi, a_21)

def wm1(chi, a_21):
    return 1/(1-a_21*np.exp(1j*chi))

def wm2(chi, a_21):
    return 1-wm1(chi, a_21)
...
ReQ_p1=((data_ifg_matrix[0]-data_ifg_matrix[2])/4+P1_corr)/(data_ifg_matrix[0]+data_ifg_matrix[2])
ReQ_p1_err=((data_ifg_matrix_err[0]**2+data_ifg_matrix_err[2]**2)/16+P1_corr_err**2+ReQ_p1**2*(data_ifg_matrix_err[0]**2+data_ifg_matrix_err[2]**2))**0.5/abs(data_ifg_matrix[0]+data_ifg_matrix[2])

ReQ_m1=(-(data_ifg_matrix[0]-data_ifg_matrix[2])/4+P1_corr)/(data_ifg_matrix[0]+data_ifg_matrix[2])
ReQ_m1_err=((data_ifg_matrix_err[2]**2+data_ifg_matrix_err[0]**2)/16+P1_corr_err**2+ReQ_m1**2*(data_ifg_matrix_err[2]**2+data_ifg_matrix_err[0]**2))**0.5/abs(data_ifg_matrix[0]+data_ifg_matrix[2])

ImQ_p1=(data_ifg_matrix[3]-data_ifg_matrix[1])/(4*(data_ifg_matrix[0]+data_ifg_matrix[2]))
ImQ_p1_err=((data_ifg_matrix_err[1]**2+data_ifg_matrix_err[3]**2)/16+ImQ_p1**2*(data_ifg_matrix_err[0]**2+data_ifg_matrix_err[2]**2))**0.5/abs(data_ifg_matrix[0]+data_ifg_matrix[2])

ReQ_p2=((data_ifg_matrix[0]-data_ifg_matrix[2])/4+P2_corr)/(data_ifg_matrix[0]+data_ifg_matrix[2])
ReQ_p2_err=((data_ifg_matrix_err[0]**2+data_ifg_matrix_err[2]**2)/16+P1_corr_err**2+ReQ_p2**2*(data_ifg_matrix_err[0]**2+data_ifg_matrix_err[2]**2))**0.5/abs(data_ifg_matrix[0]+data_ifg_matrix[2])

ImQ_p2=(data_ifg_matrix[1]-data_ifg_matrix[3])/(4*(data_ifg_matrix[0]+data_ifg_matrix[2]))
ImQ_p2_err=((data_ifg_matrix_err[1]**2+data_ifg_matrix_err[3]**2)/16+ImQ_p2**2*(data_ifg_matrix_err[0]**2+data_ifg_matrix_err[2]**2))**0.5/abs(data_ifg_matrix[0]+data_ifg_matrix[2])

Re_p1_1=((data_ifg_matrix[0]-data_ifg_matrix[2])/4+P1_corr)/(data_ifg_matrix[0])
Re_p1_1_err=((data_ifg_matrix_err[0]**2+data_ifg_matrix_err[2]**2)/16+P1_corr_err**2+Re_p1_1**2*data_ifg_matrix_err[0]**2)**0.5/abs(data_ifg_matrix[0])

Re_m1_1=(-(data_ifg_matrix[0]-data_ifg_matrix[2])/4+P1_corr)/(data_ifg_matrix[2])
Re_m1_1_err=((data_ifg_matrix_err[2]**2+data_ifg_matrix_err[0]**2)/16+P1_corr_err**2+Re_m1_1**2*data_ifg_matrix_err[2]**2)**0.5/abs(data_ifg_matrix[2])

Re_2_1=((data_ifg_matrix[0]-data_ifg_matrix[2])/4+P2_corr)/(data_ifg_matrix[0])
Re_p1_1_err=((data_ifg_matrix_err[0]**2+data_ifg_matrix_err[2]**2)/16+P2_corr_err**2+Re_2_1**2*data_ifg_matrix_err[0]**2)**0.5/abs(data_ifg_matrix[0])

Im_p1 = (data_ifg_matrix[3]-data_ifg_matrix[1])/(4*data_ifg_matrix[0])
Im_p1_err=((data_ifg_matrix_err[1]**2+data_ifg_matrix_err[3]**2)/16+Im_p1**2*data_ifg_matrix_err[0]**2)**0.5/abs(data_ifg_matrix[0])

Im_p2 = (data_ifg_matrix[1]-data_ifg_matrix[3])/(4*data_ifg_matrix[0])
Im_p2_err=((data_ifg_matrix_err[1]**2+data_ifg_matrix_err[3]**2)/16+Im_p2**2*data_ifg_matrix_err[0]**2)**0.5/abs(data_ifg_matrix[0])
 
fig = plt.figure(figsize=(9,5), dpi=150)

# Imm_1=(data_ifg_matrix[1]-data_ifg_matrix[3])/data_ifg_matrix[2]/4
# Imm_1_err=(data_ifg_matrix_err[1]**2+data_ifg_matrix_err[3]**2+(4*Im_p1)**2*data_ifg_matrix_err[2]**2)**0.5/(4*abs(data_ifg_matrix[2]))
...
S_x = S_x[((chi >= 0)) & (chi <= np.pi)]
S_x_err = S_x_err[((chi >= 0)) & (chi <= np.pi)]

fig = plt.figure(figsize=(6,9), dpi=150)
gs = fig.add_gridspec(4,1 , height_ratios=(1,1,1,1), hspace=0.0, wspace=0)
...
axs[0].set_aspect(r0/2, 'box')
# axs[0].set_yticks(axs[1].get_yticks()[1:-1])

axs[0].errorbar(S_x,ReQ_p2[((chi >= 0)) & (chi <= np.pi)], ReQ_p2_err[((chi >= 0)) & (chi <= np.pi)], fmt="k.", capsize=3, label="Data")
axs[0].errorbar(2*a_1*a_2*np.cos(chi_plt), a_2**2/2+a_1*a_2*np.cos(chi_plt)/2, color=colors[3], alpha=0.8, label="Theory")
axs[0].plot([-1,1],[1,1], colors[1], label = "Negativity\nbound")
axs[0].plot([-1,1],[0,0], colors[1])
axs[0].fill_between([-1,1], 1, 5, color= colors[1], alpha= 0.1)
axs[0].fill_between([-1,1], -5, 0, color= colors[1], alpha= 0.1)
...
axs[1].errorbar(S_x,Re_p1_1[((chi >= 0)) & (chi <= np.pi)], Re_p1_1_err[((chi >= 0)) & (chi <= np.pi)], fmt="k.", capsize=3, label="Data")
# axs[1].errorbar(S_x,Rem_1_1[((chi >= 0)) & (chi <= np.pi)], Rem_1_1_err[((chi >= 0)) & (chi <= np.pi)], fmt="kv", ms=5, capsize=3)
axs[1].errorbar(2*a_1*a_2*np.cos(chi_plt), wp1(chi_plt, a_21).real, color=colors[3], alpha=0.8, label="Theory")
# axs[1].errorbar(2*a_1*a_2*np.cos(chi_plt), wp1(chi_plt+np.pi, a_21).real, color=colors[2], alpha=0.8)
axs[1].plot([-1,1],[1,1], colors[1], label = "Eigenvalue\nbound")
axs[1].plot([-1,1],[0,0], colors[1])
axs[1].fill_between([-1,1], 1, 5, color= colors[1], alpha= 0.1)
axs[1].fill_between([-1,1], -5, 0, color= colors[1], alpha= 0.1)
# axs[1].fill_between(2*a_1*a_2*np.cos(chi_plt)+2*a_1*a_2, 1, wp1(chi_plt+np.pi/2, a_21).real, wp1(chi_plt+np.pi/2, a_21).real>1, color= colors[1], alpha= 0.1)
# axs[1].fill_between(2*a_1*a_2*np.cos(chi_plt), 1, wp1(chi_plt+np.pi, a_21).real, wp1(chi_plt+np.pi, a_21).real>1, color= colors[1], alpha= 0.1)
# axs[1].xaxis.set_inverted(True)
r1=abs(axs[1].get_xlim()[1]-axs[1].get_xlim()[0])/abs(axs[1].get_ylim()[1]-axs[1].get_ylim()[0])
axs[1].set_aspect(r1/2, 'box')

axs[2].set_ylabel("$\Re(w_{1,-})$", fontsize=13)
axs[2].set_xlim([-1,1])
axs[2].xaxis.set_inverted(True)
axs[2].set_ylim([-0.2,3])
axs[2].set_aspect(1/(2.7), 'box')
axs[2].set_yticks(axs[2].get_yticks()[1:-1])

axs[2].errorbar(S_x,Re_m1_1[((chi >= 0)) & (chi <= np.pi)], Re_m1_1_err[((chi >= 0)) & (chi <= np.pi)], fmt="k.", capsize=3, label="Data")
# axs[2].errorbar(S_x,Rem_1_1[((chi >= 0)) & (chi <= np.pi)], Rem_1_1_err[((chi >= 0)) & (chi <= np.pi)], fmt="kv", ms=5, capsize=3)
axs[2].errorbar(2*a_1*a_2*np.cos(chi_plt), wm1(chi_plt, a_21).real, color=colors[3], alpha=0.8, label="Theory")
# axs[2].errorbar(2*a_1*a_2*np.cos(chi_plt), wp1(chi_plt+np.pi, a_21).real, color=colors[2], alpha=0.8)
axs[2].plot([-1,1],[1,1], colors[1], label = "Eigenvalue\nbound")
axs[2].plot([-1,1],[0,0], colors[1])
axs[2].fill_between([-1,1], 1, 5, color= colors[1], alpha= 0.1)
axs[2].fill_between([-1,1], -5, 0, color= colors[1], alpha= 0.1)
# axs[2].fill_between(2*a_1*a_2*np.cos(chi_plt)+2*a_1*a_2, 1, wp1(chi_plt+np.pi/2, a_21).real, wp1(chi_plt+np.pi/2, a_21).real>1, color= colors[1], alpha= 0.1)
# axs[2].fill_between(2*a_1*a_2*np.cos(chi_plt), 1, wp1(chi_plt+np.pi, a_21).real, wp1(chi_plt+np.pi, a_21).real>1, color= colors[1], alpha= 0.1)
# axs[2].xaxis.set_inverted(True)
r2=abs(axs[2].get_xlim()[1]-axs[2].get_xlim()[0])/abs(axs[2].get_ylim()[1]-axs[2].get_ylim()[0])
axs[2].set_aspect(r2/2, 'box')

axs[3].errorbar(S_x, S_z+abs(S_x)*0,  xerr=S_x_err, yerr=S_z_err+abs(S_x)*0,  fmt="k.", capsize=2, label="Data")
# axs[3].plot([0,1],[1,0], "r")
axs[3].plot([-1,0],[0,1], colors[1], label = "Noncontextual\nbound")
axs[3].plot([0,1],[1,0], colors[1])
# axs[3].plot([-1,0],[0,-1], colors[1])
axs[3].plot(x_c,(1-x_c**2)**0.5, colors[2], label = "Quantum bound")
# axs[3].plot(x_c,-(1-x_c**2)**0.5, colors[2])
axs[3].set_xlim([-1,1])
axs[3].set_ylim([-0,1.1])
axs[3].set_ylabel("$\langle\\sigma_z\\rangle$",fontsize=13)
axs[3].set_xlabel("$\langle\\sigma_x\\rangle$",fontsize=13)
axs[3].set_aspect('equal', 'box')
# axs[3].fill_between(x_c, -1-x_c, -(1-x_c**2)**0.5, x_c<0,  color= colors[1], alpha= 0.1)
axs[3].fill_between(x_c, 1+x_c, (1-x_c**2)**0.5, x_c<0,  color= colors[1], alpha= 0.1)
axs[3].fill_between(x_c, 1-x_c, (1-x_c**2)**0.5, x_c>0,  color= colors[1], alpha= 0.1)
axs[3].xaxis.set_inverted(True)
axs[3].set_xticks(axs[3].get_xticks())
# axs[1].set_xticks(-axs[3].get_yticks())
# axs[3].set_yticks(axs[3].get_yticks()[:-1])
# axs[3].set_aspect('equal', 'box')
# axs[0].legend()
# axs[1].legend()
# axs[3].legend()
r3=abs(axs[3].get_xlim()[1]-axs[3].get_xlim()[0])/abs(axs[3].get_ylim()[1]-axs[3].get_ylim()[0])
axs[3].set_aspect(r3/2, 'box')
for ax in axs[:-1]:
