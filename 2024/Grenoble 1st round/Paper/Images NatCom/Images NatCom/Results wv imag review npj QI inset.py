...
axs = [fig.add_subplot(gs[:2, 0]), fig.add_subplot(gs[:2, 1]),fig.add_subplot(gs[2:4, 0]),fig.add_subplot(gs[2:4, 1]),fig.add_subplot(gs[4:6, 0]),fig.add_subplot(gs[4:6, 1])]
...
fig.savefig("/home/aaa/Desktop/Fisica/PhD/2024/Grenoble 1st round/Paper/Review npj QI/Results wv imag inset vers1.pdf", format="pdf",bbox_inches="tight")   
plt.show()