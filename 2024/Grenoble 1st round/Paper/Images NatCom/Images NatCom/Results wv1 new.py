...
axs[2].plot(chi_plt, w1(chi_plt, a_21_unb).imag, color=colors[1] )
axs[3].errorbar(chi,Im_1_bal, Im_1_bal_err, fmt="k.", capsize=3)
axs[3].plot(chi_plt, w1(chi_plt, a_21_bal).imag, color=colors[1] )
...
axs[0].errorbar(chi_plt, w1(chi_plt, a_21_unb).real, color=colors[1])
axs[1].errorbar(chi_plt, w1(chi_plt, a_21_bal).real, color=colors[1])
