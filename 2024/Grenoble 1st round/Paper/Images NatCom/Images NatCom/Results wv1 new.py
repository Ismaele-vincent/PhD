...
axs[0].set_ylabel("$w^\mathrm{R}_{1,+}$")
axs[2].set_ylabel("$w^\mathrm{I}_{1,+}$")
...
axs[2].errorbar(chi,Im_1_unb, Im_1_unb_err, fmt="k.", capsize=3)
axs[2].plot(chi_plt, w1(chi_plt, a_21_unb).imag, color=colors[3], alpha=0.8 )
axs[3].errorbar(chi,Im_1_bal, Im_1_bal_err, fmt="k.", capsize=3)
axs[3].plot(chi_plt, w1(chi_plt, a_21_bal).imag, color=colors[3], alpha=0.8 )

axs[0].set_ylim([-0.7,2.7])
axs[1].set_ylim([-0.7,2.7])
axs[0].set_yticks([-0.5,0.5,1.5, 2.5])
axs[1].set_yticks([-0.5,0.5,1.5, 2.5])

axs[2].set_ylim([-2.9,4.9])
axs[3].set_ylim([-2.9,4.9])
axs[2].set_yticks(range(-2,5,1))
axs[3].set_yticks(range(-2,5,1))

axs[0].errorbar(chi_plt, w1(chi_plt, a_21_unb).real, color=colors[3], alpha=0.8)
axs[1].errorbar(chi_plt, w1(chi_plt, a_21_bal).real, color=colors[3], alpha=0.8)
axs[0].errorbar(chi,Re_1_unb, Re_1_unb_err, fmt="k.", capsize=3)
axs[1].errorbar(chi,Re_1_bal, Re_1_bal_err, fmt="k.", capsize=3)
fig.savefig("/home/aaa/Desktop/Fisica/PhD/2024/Grenoble 1st round/Paper/Images NatCom/Results wv1.pdf", format="pdf",bbox_inches="tight")   
plt.show()