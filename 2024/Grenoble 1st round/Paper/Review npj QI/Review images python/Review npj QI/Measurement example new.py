...
fig_1 = plt.figure(figsize=(3.5,5), dpi=300)
gs = fig.add_gridspec(2,1, hspace=0.0, wspace=0)
gs_1 = fig_1.add_gridspec(2,1, hspace=0.0, wspace=0)
axs = [fig_1.add_subplot(gs[0, 0]),fig.add_subplot(gs[0, 0]),fig_1.add_subplot(gs[1, 0]),fig.add_subplot(gs[1, 0])]
...
fig.savefig("/home/aaa/Desktop/Fisica/PhD/2024/Grenoble 1st round/Paper/Review npj QI/Measurement example next setup 0.svg", format="svg",bbox_inches="tight")   
# fig_1.savefig("/home/aaa/Desktop/Fisica/PhD/2024/Grenoble 1st round/Paper/Review npj QI/Measurement example next setup pi2.pdf", format="pdf",bbox_inches="tight")
plt.show()