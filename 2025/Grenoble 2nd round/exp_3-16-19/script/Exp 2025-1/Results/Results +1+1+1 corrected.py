...
fold_results="/home/aaa/Desktop/Fisica/PhD/2025/Grenoble 2nd round/exp_3-16-19/Sorted data/Ifg wv no fit/Results Corrected/"
...
# fig_0 = plt.figure(figsize=(8,5), dpi=250)
# gs = fig_0.add_gridspec(2,3 , hspace=0.05, wspace=0.5)
# axs = [fig_0.add_subplot(gs[0, 0]),fig_0.add_subplot(gs[0, 1]),fig_0.add_subplot(gs[0, 2])]
# axs1 = [fig_0.add_subplot(gs[1, 0]),fig_0.add_subplot(gs[1, 1]),fig_0.add_subplot(gs[1, 2])]
...
# axs[0].errorbar(chi_1[N_meas],Re_1[N_meas], Re_1_err[N_meas], fmt="k.", capsize=3, ms=4)
# axs[0].plot(chi_1_plt[N_meas], w1.real[N_meas], "o", color=colors[3])
# axs[1].errorbar(chi_2[N_meas],Re_2[N_meas], Re_2_err[N_meas], fmt="k.", capsize=3, ms=4)
# axs[1].plot(chi_2_plt[N_meas], w2.real[N_meas], "o", color=colors[3])
# axs[2].errorbar(chi_3[N_meas],Re_3[N_meas], Re_3_err[N_meas], fmt="k.", capsize=3, ms=4)
# axs[2].plot(chi_3_plt[N_meas], w3.real[N_meas], "o", color=colors[3])
...
# axs1[0].errorbar(chi_1[N_meas],Im_1[N_meas], Im_1_err[N_meas], fmt="k.", capsize=3, ms=4)
# axs1[0].plot(chi_1_plt[N_meas], w1.imag[N_meas], "o", color=colors[3])
# axs1[1].errorbar(chi_2[N_meas],Im_2[N_meas], Im_2_err[N_meas], fmt="k.", capsize=3, ms=4)
# axs1[1].plot(chi_2_plt[N_meas], w2.imag[N_meas], "o", color=colors[3])
# axs1[2].errorbar(chi_3[N_meas],Im_3[N_meas], Im_3_err[N_meas], fmt="k.", capsize=3, ms=4)
# axs1[2].plot(chi_3_plt[N_meas], w3.imag[N_meas], "o", color=colors[3])
