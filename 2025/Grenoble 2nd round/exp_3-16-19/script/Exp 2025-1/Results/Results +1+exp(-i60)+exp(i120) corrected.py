...
inf_file_names=["ifg_wv1_psi_+1+exp(-i60)+exp(i120)_no_fit_22Oct1732", "ifg_wv2_psi_+1+exp(-i60)+exp(i120)_no_fit_22Oct1812", "ifg_wv3_psi_+1+exp(-i60)+exp(i120)_no_fit_22Oct1852"]
...
fig.savefig("/home/aaa/Desktop/Fisica/PhD/2025/Grenoble 2nd round/Report/Results/Results_"+(inf_file_names[0])[12:-17]+"_corrected.pdf",format='pdf', bbox_inches='tight', pad_inches=0, transparent=False)   
