...
sorted_fold_path="/home/aaa/Desktop/Fisica/PhD/2025/Grenoble 2nd round/exp_3-16-19/Sorted data/Ifg wv"
bad_apples=[]
...
for root1, dirs1, files1 in os.walk(sc_fold_path, topdown=False):
    for name1 in files1:
        if ("Prep" in name1) and (".inf" in name1):
            ...
            # print(inf_file)
            with open(inf_file_path, 'r') as src:
                lines_inf = src.readlines()
            print(lines_inf[0])
            ...
            #     cleantxt_ifg=np.loadtxt(dat_file_path, encoding='windows-1252', comments="*",skiprows=20,delimiter="\t")#15
            ...
            # cleantxt_int=np.loadtxt(int_file_path, encoding='windows-1252', comments="*",skiprows=21,delimiter="\t")
            # # print(cleantxt_int)
