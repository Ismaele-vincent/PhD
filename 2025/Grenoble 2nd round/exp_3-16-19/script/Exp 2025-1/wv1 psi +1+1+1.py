...
Re_1=I_1/I_0 + 1/4 - I_pi/(I_0*4)
Re_1_err=(I_1_err**2+(I_ppi2_err/4)**2+(Re_1-1/4)**2*I_0_err**2)**0.5/abs(I_0)

# sa=I_pi/I_0-4*Im_1**2
# s=-np.sign(sa)*abs(sa)**0.5
# Re_1=(1+s)/2
# Re_1_err=1/4*((4*I_0**4*I_pi_err**2-4*I_pi*I_0*(I_ppi2-I_mpi2)**2*I_0_err**2+(I_ppi2-I_mpi2)**4*I_0_err**2+I_0**2*(4*I_pi**2*I_0_err**2+(I_ppi2-I_mpi2)**2*(I_ppi2_err**2+I_mpi2_err**2)))/(I_0**4*(4*I_pi*I_0-(I_ppi2-I_mpi2)**2)))**0.5
