...
def fit_C(x, C_23, B, D, E):
    return A/3*(1+2*C_23-2*B*np.cos(D*x-E))
...
"""
"ifg_wv1_psi_+1-1-1_no_fit_22Oct1257"
"""
# C_12=0.77
# C_13=0.67 
# C_23=0.65
...
"""
"ifg_wv1_psi_+1-1-1_no_fit_23Oct0152"
"""
C_12=0.77
C_13=0.68
C_23=0.64
...
"""
"ifg_wv1_psi_+1-1-1_no_fit_25Oct0112"
"""
# C_12=0.81 
# C_13=0.63 
# C_23=0.45
...
inf_file_names=[
                # "ifg_wv1_psi_+1-1-1_no_fit_22Oct1257" #good 
                "ifg_wv1_psi_+1-1-1_no_fit_23Oct0152" #best
                # "ifg_wv1_psi_+1-1-1_no_fit_25Oct0112" #intensity going down
]
...
for inf_file_name in inf_file_names:
        ...
        for root, dirs, files in os.walk(cleandata, topdown=False):
            ...
            N_ifg=time_meas#*tot_data[:,5]/np.average(tot_data[:,5])
...
# print(A)
ps_pos=tot_data[:,0]
P0=[(np.amax(data_O)+np.amin(data_O))/2, 10, 6, -2.]
...
print(C_23,C_12*a_1*a_2+C_13*a_1*a_3)
...
chi_1=(ps_pos-ps_pos[0])*p_C[2]-np.pi
