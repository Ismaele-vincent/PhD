...
inf_file_names=["ifg_wv1_psi_+1-1-1_no_fit_23Oct0152" #best
]
...
print(A)
ps_pos=tot_data[:,0]
P0=[(np.amax(data_O)+np.amin(data_O))/2, 0.7, 6.1, 4.9]
...
P0_C=[C_23, C_12*a_1*a_2+C_13*a_1*a_3, 6.1, 4.8]
B0_C=([0.3,0.0,0,0.01],[1,1,7, 2*np.pi])
