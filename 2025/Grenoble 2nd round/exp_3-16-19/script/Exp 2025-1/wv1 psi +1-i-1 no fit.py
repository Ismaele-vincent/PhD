...
print((I_0[0]+I_pi[0]), 2*A/3)
print((3/(2*A)*((I_0[0]+I_pi[0]))-1)/(2*a_2*a_3*np.cos(chi_2_0-chi_3_0)),C_23)
print((I_pi[0]-I_0[0])/(4*A/3*a_1*a_3), C_13)
print((I_mpi2[0]-I_ppi2[0])/(4*A/3*a_1*a_2), C_12)
