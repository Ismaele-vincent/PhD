...
inf_file_names=[
                # "ifg_wv2_psi_+1-1-i_no_fit_21Oct1110" #good, bit noisy
                # "ifg_wv2_psi_+1-1-i_no_fit_22Oct1559" #best ?
                "ifg_wv2_psi_+1-1-i_no_fit_25Oct0348" #best
]
...
P0_C=[C_13, ((C_23*a_2*a_3)**2+(C_12*a_1*a_2)**2)**0.5, 6, 4.6]
B0_C=([-1,-0.4,0,0.01],[1,1,7, 2*np.pi])
p_C,cov_C=fit(fit_C, ps_pos, data_O, sigma=data_O_err, p0=P0_C,  bounds=B0_C)
err_C=np.diag(cov_C)**0.5
print("C_13=",p_C[0],"+-",err_C[0],"((C_23*a_2*a_3)**2+(C_12*a_1*a_2)**2)**0.5=",p_C[1],"+-",err_C[1])
print(C_13,((C_23*a_2*a_3)**2+(C_12*a_1*a_2)**2)**0.5)
# print(p_C)
