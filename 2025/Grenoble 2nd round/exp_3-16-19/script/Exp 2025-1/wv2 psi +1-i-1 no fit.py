...
inf_file_names=[
                ...
                "ifg_wv2_psi_+1-i-1_no_fit_22Oct2033" #best
                # "ifg_wv2_psi_+1-i-1_no_fit_25Oct0552" #maybe good intensity goes down
]
...
P0_C=[C_13, ((C_12*a_1*a_2)**2+(C_23*a_2*a_3)**2)**0.5, 6, 4.6]
...
print("C_13=",p_C[0],"+-",err_C[0],"((C_12*a_1*a_2)**2+(C_23*a_2*a_3)**2)**0.5=",p_C[1],"+-",err_C[1])
print(C_13,((C_12*a_1*a_2)**2+(C_23*a_2*a_3)**2)**0.5)
# print(p_C)
