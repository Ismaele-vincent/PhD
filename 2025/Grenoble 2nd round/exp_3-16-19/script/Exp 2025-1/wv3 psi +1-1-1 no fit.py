...
good_apples=["ifg_wv3_psi_+1-1-1_no_fit_22Oct1426" #big oscillations, but maybe ok
             "ifg_wv3_psi_+1-1-1_no_fit_23Oct0305" #better
             "ifg_wv3_psi_+1-1-1_no_fit_25Oct0225" #good
             ]
inf_file_names=["ifg_wv3_psi_+1-1-1_no_fit_23Oct0305"
]
...
P0_C=[C_12, C_23*a_2*a_3-C_13*a_1*a_3, 6, 4.6]
...
print("C_12=",p_C[0],"+-",err_C[0],"C_23*a_2*a_3-C_13*a_1*a_3=",p_C[1],"+-",err_C[1])
