...
bad_apples=["ifg_wv3_psi_+1-1-1_16Oct0114" #big oscillations
            ]
good_apples=["ifg_wv3_psi_+1-1-1_13Oct1107", #good, I guess
             "ifg_wv3_psi_+1-1-1_15Oct0434" #good, I guess
             "ifg_wv3_psi_+1-1-1_17Oct0302" #good
             "ifg_wv3_psi_+1-1-1_20Oct0719" #good probably
             ]
inf_file_names=["ifg_wv3_psi_+1-1-1_20Oct0719" #good probably
]
...
for inf_file_name in inf_file_names:
        ...
        for root, dirs, files in os.walk(cleandata, topdown=False):
            ...
            for name in files[:-1]:
                ...
                ps_pos=tot_data[:,0]
                P0=[(np.amax(data_ifg)+np.amin(data_ifg))/2, 0.7, 6, 1.6]
