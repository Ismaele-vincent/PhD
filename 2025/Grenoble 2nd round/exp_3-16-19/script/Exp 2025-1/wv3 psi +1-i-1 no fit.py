...
def fit_C(x, C_12, B, D, E):
    return A/3*(1+2*a_1*a_2*C_12+2*B*np.cos(D*x-E))

state="$|\\psi_{in}>=(|1>-i|2>-|3>)/\\sqrt{3}$"
...
inf_file_names=[
                # "ifg_wv3_psi_+1-i-1_no_fit_21Oct2128" #good-ish
                # "ifg_wv3_psi_+1-i-1_no_fit_22Oct2113" #best
