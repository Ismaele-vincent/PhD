...
inf_file_names=["ifg_wv1_psi_+1-i-1_no_fit_B123_B1_23Oct0757"
...
for inf_file_name in inf_file_names:
        print(inf_file_name)
        sorted_fold_path="/home/aaa/Desktop/Fisica/PhD/2025/Grenoble 2nd round/exp_3-16-19/Sorted data/Ifg wv B123/"+inf_file_name
        ...
        # gs = fig.add_gridspec(2,3 , width_ratios=(2,0.5,0.5), hspace=0.0, wspace=0.3)
        ...
        # for ax in axs:
        #     ax.set_xticks(chi[::8])
        #     # ax.set_xticklabels((chi[::8]/np.pi).astype(str))
