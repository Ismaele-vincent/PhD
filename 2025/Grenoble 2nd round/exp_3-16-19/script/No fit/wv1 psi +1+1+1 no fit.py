...
good_apples=["ifg_wv1_psi_+1+1+1_No_fit_20Oct1759" #no initial pi shift
             "ifg_wv1_psi_+1+1+1_no_fit_22Oct1050" #good
             "ifg_wv1_psi_+1+1+1_no_fit_22Oct2358" #good
             "ifg_wv1_psi_+1+1+1_no_fit_24Oct2318" #good-ish
             ]

inf_file_names=["ifg_wv1_psi_+1+1+1_no_fit_22Oct2358" #good
...
for inf_file_name in inf_file_names:
        ...
        Re_1=P1/data_ifg_matrix[0] + 1/4 - data_ifg_matrix[3]/(data_ifg_matrix[0]*4)
        Re_1_err=(P1_err**2+(data_ifg_matrix_err[2]/4)**2+(Re_1-1/4)**2*data_ifg_matrix_err[0]**2)**0.5/abs(data_ifg_matrix[0])
