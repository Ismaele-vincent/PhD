...
good_apples=["ifg_wv1_psi_+1+exp(-i60)+exp(i120)_no_fit_21Oct1303" #good, just wrong initial position
             "ifg_wv1_psi_+1+exp(-i60)+exp(i120)_no_fit_22Oct1732" #good
             "ifg_wv1_psi_+1+exp(-i60)+exp(i120)_no_fit_24Oct2117" #good probably
    ]
inf_file_names=["ifg_wv1_psi_+1+exp(-i60)+exp(i120)_no_fit_22Oct1732" #good, just wrong initial position
