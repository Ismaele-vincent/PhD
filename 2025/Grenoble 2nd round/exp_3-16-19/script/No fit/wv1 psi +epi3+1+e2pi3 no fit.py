# -*- coding: utf-8 -*-
"""
Created on Tue Oct 21 16:36:33 2025
...
good_apples=["ifg_wv1_psi_+exp(-i60)+1+exp(i120)_no_fit_21Oct1520"   #meh (64 points)
             "ifg_wv1_psi_+exp(-i60)+1+exp(i120)_no_fit_21Oct2226" #good prolly
             "ifg_wv1_psi_+exp(-i60)+1+exp(i120)_no_fit_22Oct2158" #good probably
             "ifg_wv1_psi_+exp(-i60)+1+exp(i120)_no_fit_24Oct1914" #bit noisy
    ]

inf_file_names=["ifg_wv1_psi_+exp(-i60)+1+exp(i120)_no_fit_22Oct2158" #good probably
]
# a_21=1/2
...
for inf_file_name in inf_file_names:
        ...
        chi_1_0_aux=chi_1_0 
        for i in [1,0,2,3]:
            chi_1_0=chi_1_0_aux-np.pi/2+k*np.pi/2
        ...
        fig = plt.figure(figsize=(8,6))
        ax = fig.add_subplot(111)
        ax.errorbar(chi_1, data_ifg_matrix[0],yerr=data_ifg_matrix[0]**0.5,fmt="ko",capsize=5, ms=3)
