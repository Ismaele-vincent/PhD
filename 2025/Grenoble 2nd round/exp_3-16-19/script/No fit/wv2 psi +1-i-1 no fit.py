...
bad_apples=["ifg_wv2_psi_+1-i-1_no_fit_21Oct2034" #could be repeated
            "ifg_wv2_psi_+1-i-1_no_fit_22Oct2033" #maybe good
            "ifg_wv2_psi_+1-i-1_no_fit_25Oct0552" #maybe good
            ]

good_apples=["ifg_wv2_psi_+1-i-1_no_fit_22Oct2033" #maybe good
            ]

inf_file_names=[
"ifg_wv2_psi_+1-i-1_no_fit_21Oct2034" #could be repeated
]
# a_21=1/2
...
for inf_file_name in inf_file_names:
        ...
        print("amplitudes=",a_1,a_2,a_3, (a_1**2+a_2**2+a_3**2))
        ...
        fig = plt.figure(figsize=(8,6))
        ax = fig.add_subplot(111)
        ax.errorbar(chi_2, data_ifg_matrix[0]/A,yerr=data_ifg_matrix[0]**0.5/A,fmt="ko",capsize=5, ms=3)
        ax.plot(chi_2_plt, I_corr(A, chi_1, chi_2_plt, chi_3)/A)
