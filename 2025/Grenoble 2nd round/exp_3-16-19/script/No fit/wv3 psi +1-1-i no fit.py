...
good_apples=["ifg_wv3_psi_+1-1-i_no_fit_21Oct1204" #good i guess
             "ifg_wv3_psi_+1-1-i_no_fit_22Oct1643" #good probably
             "ifg_wv3_psi_+1-1-i_no_fit_25Oct0428" #good probably
    ]
inf_file_names=["ifg_wv3_psi_+1-1-i_no_fit_22Oct1643" #good probably
]
# a_21=1/2
...
for inf_file_name in inf_file_names:
        ...
        for root, dirs, files in os.walk(cleandata, topdown=False):
            ...
            ps_pos=tot_data[:,0]
            P0=[(np.amax(data_ifg)+np.amin(data_ifg))/2, (np.amax(data_ifg)-np.amin(data_ifg))/2, 6, 4.6]
