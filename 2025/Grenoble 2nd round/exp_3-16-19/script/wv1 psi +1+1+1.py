...
bad_apples=["ifg_wv1_psi_+1+1+1_14Oct0909", #could be improved
            ]
good_apples=["ifg_wv1_psi_+1+1+1_12Oct0413",
             "ifg_wv1_psi_+1+1+1_14Oct1219", #W_im a bit asymmetric, might be normal
             "ifg_wv1_psi_+1+1+1_14Oct2108", #good
             "ifg_wv1_psi_+1+1+1_15Oct2034", #good, a bit asymmetric
             "ifg_wv1_psi_+1+1+1_16Oct2222", #good
             "ifg_wv1_psi_+1+1+1_18Oct0000", #good, but int measurement, it can be taken from other meas
             "ifg_wv1_psi_+1+1+1_20Oct0236", #good, a bit asymmetric
             ]

inf_file_names=[
"ifg_wv1_psi_+1+1+1_16Oct2222"
]
# a_21=1/2
...
for inf_file_name in inf_file_names:
        ...
        for root, dirs, files in os.walk(cleandata, topdown=False):
            ...
            for name in files[:-1]:
                ...
                B0=([np.amin(data_ifg),0,0.01,-4*np.pi],[np.amax(data_ifg)*2,np.amax(data_ifg)*2,7, 1*np.pi])
