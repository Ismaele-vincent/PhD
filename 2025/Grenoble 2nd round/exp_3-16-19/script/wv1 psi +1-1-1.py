...
bad_apples=[]
good_apples=["ifg_wv1_psi_+1-1-1_12Oct1225", #overall ok, one bad point because neighbour's mistake (12:58)
             "ifg_wv1_psi_+1-1-1_15Oct0135", #good
             "ifg_wv1_psi_+1-1-1_15Oct2341", #good
             "ifg_wv1_psi_+1-1-1_17Oct0129", #good
             "ifg_wv1_psi_+1-1-1_20Oct0544", #almost good, failed to reach 180
             ]
inf_file_names=[
"ifg_wv1_psi_+1-1-1_17Oct0129"
]
# a_21=1/2
...
for inf_file_name in inf_file_names:
        ...
        # data_ifg_matrix+=A_avg*(2*(1-C_23)+2*(1-(C_12+C_13))*np.cos(chi))
