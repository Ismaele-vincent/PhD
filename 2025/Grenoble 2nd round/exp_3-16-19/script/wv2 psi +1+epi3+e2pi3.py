...
bad_apples=["ifg_wv2_psi_+1+exp(-i60)+exp(i120)_17Oct1911", #very bad
            "ifg_wv2_psi_+1+exp(-i60)+exp(i120)_17Oct2018", #bad
            "ifg_wv2_psi_+1+exp(-i60)+exp(i120)_19Oct1121", #bad 
            ]

inf_file_names=["ifg_wv2_psi_+1+exp(-i60)+exp(i120)_19Oct1121"
...
for inf_file_name in inf_file_names:
        ...
        for root, dirs, files in os.walk(cleandata, topdown=False):
            ...
            for name in files[:-1]:
                ...
                ps_pos=tot_data[:,0]
                P0=[(np.amax(data_ifg)+np.amin(data_ifg))/2, (np.amax(data_ifg)-np.amin(data_ifg))/2, 6, -4.5]
