...
bad_apples=["ifg_wv2_psi_+1-1-i_12Oct0844", #PS reached 6 deg, probably bad contrast range
            "ifg_wv2_psi_+1-1-i_11Oct2152", #Same as before
            "ifg_wv2_psi_+1-1-i_13Oct1549", #bad contrast, probably due to relative PSs pos
            "ifg_wv2_psi_+1-1-i_14Oct1048", #noisy ifgs wrong fits
            ]

good_apples=["ifg_wv2_psi_+1-1-i_15Oct1059", #good 15s
            "ifg_wv2_psi_+1-1-i_19Oct1543" #maybe good, switched fits, for some reason
            "ifg_wv2_psi_+1-1-i_19Oct2120" #swithced fit, again 
            "ifg_wv2_psi_+1-1-i_20Oct1908" #ok-ish switched
            ]

inf_file_names=[
"ifg_wv2_psi_+1-1-i_15Oct1059"
]
# a_21=1/2
...
for inf_file_name in inf_file_names:
        ...
        for root, dirs, files in os.walk(cleandata, topdown=False):
            ...
            for name in files[:-1]:
                ...
                B0=([np.amin(data_ifg),0,0.01,0*np.pi],[np.amax(data_ifg)*2,np.amax(data_ifg)*2,7, 4*np.pi])
        ...
        # Re_2=P2_corr/data_ifg_matrix[1] + 1/4 - data_ifg_matrix[2]/(data_ifg_matrix[1]*4)
        ...
        # Im_2=(data_ifg_matrix[0]-data_ifg_matrix[3])/data_ifg_matrix[1]/4
