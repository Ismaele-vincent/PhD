...
fig = plt.figure(figsize=(2,4.5), dpi=300)
gs = fig.add_gridspec(2,1, wspace=0, hspace=0)
axs = [fig.add_subplot(gs[0,0]),fig.add_subplot(gs[1,0])]
fig.suptitle("Experimentally measured\npath weak value", y=0.96, fontsize=10)
# axs[0].set_xlabel("Paths relative phase [rad]")
axs[1].set_xlabel("Paths relative phase [rad]")
axs[0].set_ylabel("Real part")
...
axs[1].plot(chi_plt, w1(chi_plt, a_21).imag, color=colors[3], alpha=0.8 )
axs[0].set_ylim([0.4,2.6])
axs[0].set_yticks(axs[0].get_yticks()[1::2])
...
# axs[0].legend()
# axs[1].legend(loc=9)
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2025/ILL proposal 1st cycle/Images/Results"+folder_name[5:]+".pdf", format="pdf",bbox_inches="tight")
