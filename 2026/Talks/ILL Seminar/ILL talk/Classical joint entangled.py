...
#Draw symbols
# ax.plot(1,1,0.9, "o", color=colors[1], ms=20, clip_on=False)
# ax.plot(1,2,0.8, "o", color=colors[2], ms=20, clip_on=False)
# ax.plot(2,1,0.8, "^", color=colors[1], ms=20, clip_on=False)
# ax.plot(2,2,0.9, "^", color=colors[2], ms=20, clip_on=False)
# Draw bars
...
# plt.tight_layout()
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2026/Talks/ILL Seminar/Classical joint entangled.svg", format="svg", bbox_inches='tight', pad_inches=0, transparent=True)
plt.show()