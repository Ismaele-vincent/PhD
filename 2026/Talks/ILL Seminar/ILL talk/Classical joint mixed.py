...
# plt.tight_layout()
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2026/Talks/ILL Seminar/Classical joint mixed.svg", format="svg", bbox_inches='tight', pad_inches=0, transparent=True)
plt.show()