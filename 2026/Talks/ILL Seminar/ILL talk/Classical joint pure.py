...
ax.plot(2,2,1.15, "^", color=colors[2], ms=20, clip_on=False)
# Draw bars
...
# plt.tight_layout()
plt.savefig("/home/aaa/Desktop/Fisica/PhD/2026/Talks/ILL Seminar/Classical joint pure.svg", format="svg", bbox_inches='tight', pad_inches=0, transparent=True)
plt.show()