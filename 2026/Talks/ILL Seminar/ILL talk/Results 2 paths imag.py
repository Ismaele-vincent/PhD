...
fig_u = plt.figure(figsize=(5,5), dpi=250)
fig_b = plt.figure(figsize=(5,5), dpi=250)
...
gs_u = fig_u.add_gridspec(1,2 , hspace=0, wspace=0)
gs_b = fig_b.add_gridspec(1,2 , hspace=0, wspace=0)
axs = [fig_u.add_subplot(gs_u[0, 0]),fig_u.add_subplot(gs_u[0, 1]),fig_b.add_subplot(gs_b[0, 0]),fig_b.add_subplot(gs_b[0, 1]),]
...
axs[0].set_ylabel("Imaginary part of the weak value")
axs[2].set_ylabel("Imaginary part of the weak value")
# axs[1].plot([-1.5,1], [1.1,1.1], transform=axs[1].transAxes, lw=1.5, color="#cc00cc",clip_on=False)
# axs[1].plot([1.07,1.07], [0.37,0.63], transform=axs[1].transAxes, lw=3., color='w', clip_on=False)
# axs[1].text(0, 1.15, "Unbalanced", color="#cc00cc", ha="center", va="center", rotation=-0, transform=axs[1].transAxes)
...
fig_u.savefig("/home/aaa/Desktop/Fisica/PhD/2026/Talks/ILL Seminar/Results imag unb.svg",format='svg', bbox_inches='tight', pad_inches=0, transparent=False)   
fig_b.savefig("/home/aaa/Desktop/Fisica/PhD/2026/Talks/ILL Seminar/Results imag bal.svg",format='svg', bbox_inches='tight', pad_inches=0, transparent=False)   
plt.show()