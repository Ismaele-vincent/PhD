...
axs[0].set_ylabel("Real part of the weak value")
axs[2].set_ylabel("Real part of the weak value")
...
# axs[0].legend()
fig_u.savefig("/home/aaa/Desktop/Fisica/PhD/2026/Talks/ILL Seminar/Results real unb.svg",format='svg', bbox_inches='tight', pad_inches=0, transparent=False)   
